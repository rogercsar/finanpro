...
DROP POLICY IF EXISTS "Users can create own budget limits" ON budget_limits;
...
DROP POLICY IF EXISTS "Users can update their own alerts (e.g. mark as read)" ON alerts;
